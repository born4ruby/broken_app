  ...
  show_doc_embed_file: ->
    ...
    $('.show_doc_embed_file').click ->
      ...
      $.ajax
        ...
        url: key_url
        success: (data, textStatus, jqXHR) ->
          #$("##{iframe}").attr("src", "http://docs.google.com/gview?url=http://app.transactionmanagement.com/docs/#{data}/show_file&embedded=true")
          #$("##{iframe}").load("http://app.transactionmanagement.com/docs/#{data}/show_png")
          $.ajax
